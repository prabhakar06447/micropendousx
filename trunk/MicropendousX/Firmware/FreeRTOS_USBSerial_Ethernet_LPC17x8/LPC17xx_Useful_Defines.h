 ...
 * @purpose: CMSIS Cortex-M3 Header File
 *----------------------------------------------------------------------------
 *
...
#define ATOMIC_RESTORESTATE
	...
	/* Various LPC17xx models have differing functionality */
				...
				defined(_LPC1755_)  || defined(_LPC1754_))
		#define _LPC_SERIES_175x_
	#endif

	#if (defined(_LPC1769_) || defined(_LPC1768_) ||  \
				defined(_LPC1767_) || defined(_LPC1766_) ||  \
				defined(_LPC1765_)  || defined(_LPC1764_))
		#define _LPC_SERIES_176x_
	#endif

	#if (!(defined(_LPC_SERIES_175x_) || defined(_LPC_SERIES_176x_)))
		#error Currently selected LPC17xx model is not supported or not defined
	#endif



/* LPC1758 does not have functional MIIM and its functionality is different
 * from the LPC176x.  The following actually checks the model the code is
 * running on.  It may be more prudent vs. using the above defines.
 */
extern char dev_175x;
...
/* Place the following code in main() or a startup function to set dev_175x
...
#endif  /* __LPC17xx_USEFUL_DEFINES_H */
