...
/* There are in fact 2 more buffers than descriptors as the two Tx 
   descriptors use the same buffer to speed up the uip Tx.
*/
...
#define PHY_REG_MICR        0x11        /* Mode Control/Status Register      */
#define PHY_REG_MISR        0x12        /* Special Modes Register            */
#define PHY_REG_SYMERRCNT   0x1A        /* Symbol Error Count Register       */
#define PHY_REG_CNTSTS      0x1B        /* Control/Status Indication Register*/
#define PHY_REG_INT         0x1D        /* Interrupt Source Register         */
#define PHY_REG_INTMASK     0x1E        /* Interrupt Mask Register           */
#define PHY_REG_SPECIAL     0x1F        /* Special Control/Status Register   */
...
#define DP83848C_DEF_ADR   0x0100       /* DP83848 PHY device address        */
#define LAN8720_DEF_ADR      0x0100     /* LAN8720 PHY device address        */
#define PHY_DEF_ADR     LAN8720_DEF_ADR /* PHY device address                */

/* DP83848 PHY Identifier = 00100000000000000101110010010000 = 0x20005C90    */
/* LAN8720 PHY Identifier = 00000000000001111100000011110000 = 0x0007C0F0    */
/* Final 4 bits are silicon revision number and are AND'ed away when checking*/
#define DP83848C_ID     0x20005C90      /* DP83848 PHY Identifier            */
