/*
  Copyright 2010-02 By Opendous Inc. (www.opendous.org)
...
/* External functions that perform IRQ Handling which are
 * used below in the NVIC Handler Functions table.
 */
/* TODO - Add external function defines for handlers placed in NVIC table */
extern void USB_General_Interrupt_Handler(void);
...
*/
/* TODO - replace any of the defualt handlers with your own to
 * handle the corresponding interrupt.
 * Your function should be of the form: static void MyX_Handler(void) {}
 */
...
void (* const _NVIC_Handler_Functions[])(void) =
{
	...
	0,		// -1  14 0x3C	PendSV Handler
	0,		//  0  15 0x40	SysTick Handler
	...
	USB_General_Interrupt_Handler,		// 24 40 0xA0	USB USB_INT_REQ_LP, USB_INT_REQ_HP, USB_INT_REQ_DMA
